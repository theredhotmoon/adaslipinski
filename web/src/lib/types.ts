// Mirror of frontend/src/features/fundraising/types.ts. Kept in sync by hand so the
// Astro render layer and the SPA can't silently drift apart. If the CMS payload
// shape changes, update BOTH this file and the SPA's types.ts.
